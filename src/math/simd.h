...
struct alignas(16) Float4 {
    ...
    float operator[](int i) const { alignas(16) float f[4]; _mm_store_ps(f, v); return f[i]; }
    ...
    Float4& operator+=(Float4 o) { v = _mm_add_ps(v, o.v); return *this; }
    Float4& operator*=(Float4 o) { v = _mm_mul_ps(v, o.v); return *this; }
...
inline Float4 fmadd4(Float4 a, Float4 b, Float4 c) { return Float4(_mm_fmadd_ps(a.v, b.v, c.v)); }
inline Float4 rcp4(Float4 a)  { return Float4(_mm_div_ps(_mm_set1_ps(1.f), a.v)); }
...
struct alignas(32) Float8 {
    ...
    Float8 operator<(Float8 o)  const { return Float8(_mm256_cmp_ps(v, o.v, _CMP_LT_OQ)); }
    Float8 operator>(Float8 o)  const { return Float8(_mm256_cmp_ps(v, o.v, _CMP_GT_OQ)); }
    Float8 operator<=(Float8 o) const { return Float8(_mm256_cmp_ps(v, o.v, _CMP_LE_OQ)); }

    int movemask() const { return _mm256_movemask_ps(v); }
};

inline Float8 min8(Float8 a, Float8 b) { return Float8(_mm256_min_ps(a.v, b.v)); }
inline Float8 max8(Float8 a, Float8 b) { return Float8(_mm256_max_ps(a.v, b.v)); }
inline Float8 fmadd8(Float8 a, Float8 b, Float8 c) { return Float8(_mm256_fmadd_ps(a.v, b.v, c.v)); }
